...
<head>
    ...
    <style>
        ...
        * {
        ...
        .orbit-ring-2 {
            animation: orbitRing2 50s linear infinite;
        }
...
<body>
    ...
    <script type="module">
        ...
        // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        //  1.  useCounter  –  animated number with easing
        // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
            ...
            useEffect(() => {
                const timer = setTimeout(() => {
                    ...
                    const animate = (currentTime) => {
                        ...
                        // easeOutQuart for a smooth settle
        ...
        // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        //  2.  GlobeCanvas  –  realistic 3D Earth with continents,
        //      atmosphere, arcs, particles, and glow.
        // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        const GlobeCanvas = ({ className = '' }) => {
            ...
            //   These are coarse but recognizable. We'll draw them as filled
            //   polygons on the sphere surface.
            ...
            const drawContinent = useCallback((ctx, points, color, radius, rotY, cx, cy) => {
                ...
                // only draw if at least some points are in front
                ...
                // sort by z for proper depth (back to front) – but we'll just draw
                ctx.beginPath();
        ...
        // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        //  3.  Hero  –  main component with all improvements
        // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        const Hero = () => {
                ...
                section className = "relative min-h-screen pt-28 sm:pt-36 lg:pt-40 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden flex items-center bg-[#020916]" >
                    ...
                    div className = "max-w-7xl mx-auto w-full relative z-10 grid lg:grid-cols-12 gap-12 lg:gap-10 items-center" >
                        ...
                        div className = "text-left w-full lg:col-span-7 z-20" >
                            ...
                            { /* description – more scannable with better line-height */ } <
                            ...
                            <
                            a href = "#services"
                            className = "group w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-4 border border-[#D4AF37]/40 text-[#D4AF37] font-medium text-sm rounded-md hover:bg-[#D4AF37]/10 hover:border-[#D4AF37] hover:-translate-y-0.5 transition-all duration-300 no-underline tracking-wide" >
                            <
                            span > Explore Our Services < /span> <
                            svg className = "w-4 h-4 opacity-70 group-hover:opacity-100 transition-opacity duration-300"
                            fill = "none"
                            viewBox = "0 0 24 24"
                            stroke = "currentColor" >
                            <
                            ...
                            div className = "grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 border-t border-white/5 pt-8" >
                            {
                                stats.map((stat, i) => ( <
                                    div key = { i }
                                    className = "metric-card p-3 sm:p-4 rounded-xl border border-white/[0.03] bg-gradient-to-br from-white/[0.02] to-transparent hover:bg-white/[0.05] hover:border-[#D4AF37]/25 transition-all duration-300 cursor-default" >
                                    <
                            ...
                            div className = "relative w-[480px] h-[480px] xl:w-[540px] xl:h-[540px] flex items-center justify-center group/globe animate-fadeIn" >
                                ...
                                { /* orbiting flags */ } {
                                    countriesData.map((country, index) => {
                                        ...
                                        return ( <
                                            div key = { index }
                                            className = "absolute left-[50%] top-[50%] -ml-9 -mt-9 z-20 animate-orbit"
                                            style = { orbitStyles } >
                                            <
