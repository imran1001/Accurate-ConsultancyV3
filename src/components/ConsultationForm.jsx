...
const ConsultationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Inject your unique Web3Forms Access Key
    submitData.append("access_key", "b29ca9ee-eede-40a0-9479-fc890a51140b");
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-bold mb-2" htmlFor="fullName" style={{ color: '#0a1628' }}>
                      Full Name *
                    </label>
                  ...
                  <div>
                    <label className="block text-sm font-bold mb-2" htmlFor="email" style={{ color: '#0a1628' }}>
                      Email Address *
                    </label>
                    <div className="relative">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-bold mb-2" htmlFor="phone" style={{ color: '#0a1628' }}>
                      Phone / WhatsApp *
                    </label>
                    <div className="relative">
                  ...
                  <div>
                    <label className="block text-sm font-bold mb-2" htmlFor="visaType" style={{ color: '#0a1628' }}>
                      Visa Category *
                    </label>
                    <div className="relative">
                      ...
                      >
                        ...
                        <option value="Skilled Immigration">Skilled Immigration</option>
                ...
                {/* Row 3 - Country */}
                <div>
                  <label className="block text-sm font-bold mb-2" htmlFor="country" style={{ color: '#0a1628' }}>
                    Destination Country *
                  </label>
                  <div className="relative">
                ...
                {/* Row 4 - Message */}
                <div>
                  <label className="block text-sm font-bold mb-2" htmlFor="message" style={{ color: '#0a1628' }}>
