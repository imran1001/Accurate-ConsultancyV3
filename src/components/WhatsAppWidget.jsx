...
// Configure your configuration numbers and labels here
const WA_NUMBERS = [
 ...
 * Opens a clean chooser panel when clicked so users can choose the right department.
 */
      ...
      {open && (
        <div
          className="w-72 bg-white rounded-2xl shadow-2xl border border-gray-100 
                     overflow-hidden transition-all duration-300 transform translate-y-0"
          role="dialog"
